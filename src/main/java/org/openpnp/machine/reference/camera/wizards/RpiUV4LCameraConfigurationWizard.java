...
public class RpiUV4LCameraConfigurationWizard extends AbstractConfigurationWizard {
    private final RpiUV4LCamera camera;
    ...
    public RpiUV4LCameraConfigurationWizard(RpiUV4LCamera camera) {
        this.camera = camera;
